...
if( $step == 'check' ) {
	...
	Currently installed: <strong><?= $postamt_version ?></strong></p>
	<?php

	$release_notes = array();

	$new_version_available = false;
	if( $release_name != $postamt_version ) {
		$version_number_old = explode('.', str_replace('alpha.', '0.0.', $postamt_version));
	...
	curl_setopt( $ch, CURLOPT_USERAGENT, 'maxhaesslein/postamt/'.$postamt_version );
	...
	<p>Currently installed version: <em><?= $postamt_version ?></em></p>
